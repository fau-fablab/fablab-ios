...
class MailComposeHelper : NSObject {
    ...
    func getMailComposeViewController(#delegate: MFMailComposeViewControllerDelegate, recipients: [String], subject: String, messageBody: String, isHTML: Bool) -> MFMailComposeViewController {
    ...
    func showOutOfStockMailComposeView(#delegate: MFMailComposeViewControllerDelegate, recipients: [String], productId: String, productName: String) -> MFMailComposeViewController {
    ...
    func getMessageBody(#productId: String, productName: String) -> String {
    ...
    func getCancelAlertController() -> UIAlertController {
    ...
    func getSentAlertController() -> UIAlertController {
